...
{
	// Ship ball1=Ship(4.2,5.3);
	// cout <<ball1.GetShipInformation()<<endl;
	Test t("Testing the Initialisation of Ship");
...
bool SettingShipTests()
{
	...
	Test t("Testing the Setting Paramaters of Ship");
...
{
	// Ship ball1=Ship(9.7,4.3);
	// ball1.SetVelocity(4.5,-6.7);
	// ball1.SetPosition(-5.3,3.4);
	// ball1.UpdateShip(1);
	Test t("Testing the update parameters of Ship");
