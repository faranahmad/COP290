...
// {
// 	FileReceiving p;
// 	p.LoadSharingFromDisk("Sharing.txt");
// 	p.AddNewLocation("kg.k");
// 	p.AddNewLocationType("anu.mp4",1);
// 	p.StoreSharingToDisk("Sharing.txt");
// 	p=FileReceiving();
// 	Sharing xyz;
// 	xyz.FilePath="faran.cmd";
// 	xyz.ShareType=1;
// 	p.InsertNewInDisk("Sharing.txt",xyz);
// 	return 0;
// }
