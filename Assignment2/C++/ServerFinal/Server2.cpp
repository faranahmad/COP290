                ...
                case 1 : // File transfer from client to server case 1 and return filepath
                    {
                        ...
                        std::string location="/home/faran/Desktop/DeadDropServer/"; //location of the file where we search
                ...
                case 15: //Get server files path of a user.
                    {
                        ...
                        std::vector<std::string> files=GetFiles("/home/faran/Desktop/DeadDropServer/"+name+"/");
                        for(int i=0;i<files.size();i++)
                        {
                            std::string mp="/home/faran/Desktop/DeadDropServer";
                        ...
                        std::ofstream outfile("/home/faran/Desktop/DeadDropServer/"+name+"/.data/serverfiles.txt");
                        int index;
