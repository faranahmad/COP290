...
\title{\vspace*{\fill} \textbf{COP 290 Assignment 2}
	  ...
	  \\  \vspace{3mm} \includegraphics[width=5cm]{ddlogo.png}}
			...
			\subsection{UI Testing}
				...
				\begin{itemize}
					\item \textbf{User verification Testing}
						\newline
						To test user verification part, new users were created in the back end. Then, their validity would be tested by typing their user name and password in their respective fields to see if they are able to login to their account. The output of user name and password entered were also displayed on the terminal to check our input manually. 
